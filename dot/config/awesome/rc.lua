...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "1-master", "2-mutt", "3-bash", "4-web", "5-git", "6-movie", "7-work", "8-kernel", "9-photo" }, s, layouts[2])
end
-- }}}
...
memwidget = widget({ type = "textbox" })
	...
	vicious.register(memwidget, vicious.widgets.mem, "" .. colwhi .. "RAM " .. coldef .. colwhi .. "$1% ($2 MiB) " .. coldef .. "", 13)
	...
	vicious.register(volwidget, vicious.widgets.volume,
		function (widget, args)
			if args[1] == 0 or args[2] == "♩" then
				return "" .. colbred .. "vol " .. coldef .. colbred .. "mute" .. coldef .. "" 
			else
				return "" .. colwhi .. "vol " .. coldef .. colwhi .. args[1] .. "% " .. coldef .. ""
			end
		end, 2, "Master" )
	volwidget:buttons(
